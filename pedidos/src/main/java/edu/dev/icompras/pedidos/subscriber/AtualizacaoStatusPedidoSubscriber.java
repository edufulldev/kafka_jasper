package edu.dev.icompras.pedidos.subscriber;

import com.fasterxml.jackson.databind.ObjectMapper;
import edu.dev.icompras.pedidos.service.AtualizacaoPedidoService;
import edu.dev.icompras.pedidos.subscriber.representation.AtualizacaoStatusPedidoRepresentation;
...
public class AtualizacaoStatusPedidoSubscriber {
    ...
    private final AtualizacaoPedidoService service;
    ...
    public void receberAtualizacao(String json) {
        ...
        try {
            ...
            log.info("pedido foi atualizado");
        } catch (Exception e) {
