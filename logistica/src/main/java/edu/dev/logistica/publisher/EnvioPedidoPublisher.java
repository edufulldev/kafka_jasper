package edu.dev.logistica.publisher;

import com.fasterxml.jackson.databind.ObjectMapper;
import edu.dev.logistica.model.AtualizacaoEnvioPedido;
...
public class EnvioPedidoPublisher {
    ...
    public void enviar(AtualizacaoEnvioPedido atualizacaoEnvioPedido) {
        ...
        try {
            ...
            log.info("publicado o pedido enviado {}, código de rastrreio: {}", atualizacaoEnvioPedido.codigo(), atualizacaoEnvioPedido.codigoRastreio());
